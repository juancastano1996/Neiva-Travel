...
@Component({
  selector: 'app-rutacafe',
  templateUrl: './rutacafe.page.html',
  styleUrls: ['./rutacafe.page.scss'],
})
export class RutacafePage implements OnInit {
        ...
        "source": {
          ...
          "data": {
            ...
            "features": [{
              ...
              "type": "Feature",
              "properties": {
                "description": "<strong>Predio Villa Camila</strong><p><strong>Vereda Santa Lucia </strong>Km 18</p>",
                "icon": "ranger-station"
              },
              "geometry": {
                "type": "Point",
                "coordinates": [-75.13073444366455, 2.9157824178917155]
              }
            }, {
              "type": "Feature",
              "properties": {
              ...
              "type": "Feature",
              "properties": {
                "description": "<strong>Predio El Mesón</strong><p><strong>Vereda Primavera </strong>Km 30</p>",
                "icon": "ranger-station"
              },
              "geometry": {
                "type": "Point",
                "coordinates": [-75.10535001754761, 2.8799082079095815]
              }
            }
          ]
        }
